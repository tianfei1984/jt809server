...
public class MessageModel {
	...
	public MessageModel(int _msgType) {
		msgType = _msgType;
		headFlag = "5b";
		endFlag = "5d";
	...
	public MessageModel(int _msgType, String body)
	{		
		msgType = _msgType;
		messageBody = body;
		headFlag = "5b";
	...
	public MessageModel(int _msgType, int _subType,String body)
	{		
		msgType = _msgType;
		subType = _subType;
		messageBody = body;
	...
	public String ToHexString() {
		return Tools.getHeaderAndFlag(GlobalConfig.getSN(), messageBody, msgType,
				msgGNSSCenterID,T809Manager.encrypt);
	}
